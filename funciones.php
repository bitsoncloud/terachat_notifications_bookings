...
function parseMSGBooking($msg, $booking_id, $from_state = ""){
    ...
    $msg = str_replace("[booking-date]", date(apply_filters( 'woocommerce_bookings_date_format', wc_bookings_date_format() ).apply_filters( 'woocommerce_bookings_time_format', ', ' . wc_bookings_time_format() ), $reserva->get_date_created()) , $msg);
